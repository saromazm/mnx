/*
 * File: EnhancedIconMenu.js | Package: monoux
 *
 * Author:    Miguel Zamora Serrano <mzamoras@backlogics.com>
 * Created:   1 Jun, 2017 | 11:31 AM
 *
...
class EnhancedIconMenu extends Component {
    static muiName = 'EnhancedIconMenu';
    ...
    static propTypes = {
        ...
        /**
         * If true, the `EnhancedIconMenu` is opened.
         */
        open: PropTypes.bool,
        /**
    ...
    render() {
        ...
        warning(iconButtonElement.type.muiName !== 'SvgIcon',
            `Material-UI: You shoud not provide an <SvgIcon /> to the 'iconButtonElement' property of <EnhancedIconMenu />.
...
export default EnhancedIconMenu;